//
//  BrumbyVideo360EntityTestRV.swift
//  seek_uga_ver_1
//
...
struct BrumbyVideo360EntityTestRV: View {
    ...
    var body: some View {
        RealityView() { content in
            ...
            guard let url = Bundle.main.url(forResource: "brumby", withExtension: "mp4") else {fatalError("Video was not found!")}
