...
struct MLCVideo360EntityTestRV: View {
    ...
    var body: some View {
        RealityView() { content in
            ...
            guard let url = Bundle.main.url(forResource: "mlc", withExtension: "mp4") else {fatalError("Video was not found!")}
