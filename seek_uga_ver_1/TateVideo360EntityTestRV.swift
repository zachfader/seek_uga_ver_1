//
//  TateVideo360EntityTestRV.swift
//  seek_uga_ver_1
//
...
struct TateVideo360EntityTestRV: View {
    ...
    var body: some View {
        RealityView() { content in
            ...
            guard let url = Bundle.main.url(forResource: "tate", withExtension: "mp4") else {fatalError("Video was not found!")}
