//
//  SanfordVideo360EntityTestRV.swift
//  seek_uga_ver_1
//
//  Created by Zach Fader on 10/20/24.
//
...
struct SanfordVideo360EntityTestRV: View {
    ...
    var body: some View {
        RealityView() { content in
            ...
            guard let url = Bundle.main.url(forResource: "sanford", withExtension: "mp4") else {fatalError("Video was not found!")}
